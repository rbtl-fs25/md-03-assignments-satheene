...
3.  How many variables are in the data set? 8 (number of colums)

4.  How many observations are in the data set? 344 (number of rows)
...
5.  What data types are contained in the variables? (Reminder: [https://rbtl-fs24.github.io/website/slides/lec-02-visualisation.html#/types-of-variables](https://ds4owd-001.github.io/website/slides/lec-02-visualisation.html#/types-of-variables){.uri})
    ...
    We have integer values (body_mass_g, flipper_length_mm, years) which are discrete variables, dbl values (bill_length_mm, bill_depth_mm) which are continuous variables, and fct values (species, island, sex) which are non-numerical values.
